      ...
      <div class="container py-lg-5">
        ...
        <div class="row mt-5">
          <div class="col-md-9 mx-auto">
            <img src="asset/images/banner5.jpg" class="img-fluid" alt="">
          </div>
        </div>
      </div>
  </section>
    ...
    <div class="team-block py-5">
      <div class="container py-lg-5">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-6 mt-lg-5 mt-4">
            <div class="box16">
              <a href="#url"><img src="asset/images/team5.jpg" alt="" class="img-fluid" /></a>
              <div class="box-content">
                <h3 class="title"><a href="#url">Johnson</a></h3>
                <span class="post">Description</a></span>
                <ul class="social">
          ...
          <div class="col-lg-4 col-6 mt-lg-5 mt-4">
            <div class="box16">
              <a href="#url"><img src="asset/images/team6.jpg" alt="" class="img-fluid" /></a>
              <div class="box-content">
                <h3 class="title"><a href="#url">Johnson</a></h3>
                <span class="post">Description</a></span>
                <ul class="social">
